            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    if(!user.isEmailVerified()){
                        Intent intent = new Intent(com.example.simpleapp.Student.StudentResister.this, StudentLogin.class);
                    ...
                    Log.d("login",error);
                    Toast.makeText(com.example.simpleapp.Student.StudentResister.this,"error",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
        ...
        if(user != null){
            user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(com.example.simpleapp.Student.StudentResister.this,"check email for verification",Toast.LENGTH_LONG).show();
