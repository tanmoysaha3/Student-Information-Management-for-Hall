            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    if(!user.isEmailVerified()){
                        Intent intent = new Intent(HallAdminCreate.this, MainDashboard.class);
                    ...
                    Log.d("login",error);
                    Toast.makeText(HallAdminCreate.this,"error",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
        ...
        if(user != null){
            user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(HallAdminCreate.this,"check email for verification",Toast.LENGTH_LONG).show();
