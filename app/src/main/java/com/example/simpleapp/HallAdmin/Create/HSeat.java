...
import com.example.simpleapp.Super_Admin.Screate.HallList;
import com.example.simpleapp.Super_Admin.Screate.Hmodel;
...
public class HSeat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_h_seat);
        ...
        mListViewHall.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), HSeat1.class);
    ...
    protected void onStart() {
        ...
        databaseHall.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                ArrayAdapter adapter= new HallList(HSeat.this, hallList);
