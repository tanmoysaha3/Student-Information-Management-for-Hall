...
import com.example.simpleapp.SuperAdmin.Screate.RoomList;
...
public class HSeat2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_h_seat2);
    ...
    protected void onStart() {
        ...
        databaseRoom.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                ArrayAdapter adapter= new RoomList(HSeat2.this, roomList);
