...
public class Assignstudent1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assignstudent1);
        ...
        mListViewFloor.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), Assignstudent2.class);
    ...
    protected void onStart() {
        ...
        databaseFloor.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                ArrayAdapter adapter= new FloorList(Assignstudent1.this, floorList);
