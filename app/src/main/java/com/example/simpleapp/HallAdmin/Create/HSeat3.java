...
import com.example.simpleapp.SuperAdmin.Screate.Room;
...
public class HSeat3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_h_seat3);
    ...
    protected void onStart() {
        ...
        databaseSeat.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                ArrayAdapter adapter= new SeatList(HSeat3.this, seatList);
